...
const Footer = () => {
  ...
  return (
    <div className="bg-amber-300 py-24 px-20">
      ...
      <div>
      <h3 className="text-xl font-bold">WeDu</h3>
          ...
          <div className="grid col-span-2">
            ...
            <div>
              ...
              <div className="mb-4 flex mt-2 items-center">
                <div
                  className={`flex justify-center items-center w-4 h-4 border-2 border-black rounded-sm cursor-pointer`}
                  onClick={handleCheckboxChange}
                >
                  {isChecked && <TiTick className="text-black" />}
                </div>
